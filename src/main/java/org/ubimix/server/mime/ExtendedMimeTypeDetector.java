 ...
 * 
 */
package org.ubimix.server.mime;
...
public class ExtendedMimeTypeDetector implements IMimeTypeDetector {
    ...
    /**
     * @see org.ubimix.server.mime.IMimeTypeDetector#getMimeType(java.io.InputStream)
     */
    @Override
    ...
    /**
     * @see org.ubimix.server.mime.IMimeTypeDetector#getMimeTypeByExtension(java.lang.String)
     */
    @Override
    @SuppressWarnings("unchecked")
